...
RSpec.describe "PostsController", type: :request do
  ...
  before do
    post "http://localhost:3000/users/sign_in", params: {user: {email: "test1@gmail.com", password: "123456"}}
  end
...
RSpec.describe "RegistrationController", type: :request do
  it "success registration" do
    post "http://localhost:3000/users/", params: {user: {email: "test5@gmail.com", password: "123456"}}
